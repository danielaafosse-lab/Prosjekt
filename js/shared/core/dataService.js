/**
 * DataService - Domain data layer for Firestore-backed EconSim.
 *
 * Wraps the generic Firestore CRUD layer (firebaseService) with caching
 * and the domain API consumed by the rest of the app.
 *
...
import { STORAGE_KEYS, APP_CONFIG, ACCOUNT_PREFIXES, USER_TYPES } from '../config/config.js';
...
export { STORAGE_KEYS } from '../config/config.js';